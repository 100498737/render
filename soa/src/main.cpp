...
int main(int argc, char * argv[]) {
  ...
  // Construcción “no usada” de la cámara para enlazar el ctor con DOF.
  // Evita warnings con [[maybe_unused]] porque no la usamos aún.
  render::camera cam{
